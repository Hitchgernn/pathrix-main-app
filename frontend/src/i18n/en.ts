...
export const en: Messages = {
  ...
  "layer.transit.meta": "Halte from the MAPID survey, Kota Yogyakarta",
  ...
  "place.communitySurvey": "Community survey",
  "place.surveyNote": "Survey note",
  "place.surveyedBy": "Surveyed by",
  "place.community": "Community",
  "place.surveyedAt": "Survey date",
  "place.photos": (n: number) => `${n} survey photos`,
  ...
  "transit.stops": "Stops on this route",
  ...
  "transit.effectiveUntil": (date: string) => `until ${date}`,
  "transit.freshness": (status: string) => `Data status: ${status}`,
  "transit.noSchedule": "Detailed schedule is not available for this stop yet.",
  "transit.loadingSchedule": "Loading stop schedule…",
  "transit.scheduleError": "The stop schedule could not be loaded.",
  "transit.headwayRange": (min: number, max: number) => `Every ${min}–${max} min`,
  "transit.serviceHours": (start: string, end: string) => `${start}–${end}`,
  "transit.approximate": "estimated",
  "transit.scheduleBasis": (basis: string) => `Schedule basis: ${basis}`,
  "transit.source": "Schedule source",
